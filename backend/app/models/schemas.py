...
class InvoiceOut(BaseModel):
    ...
    de_acc_no: Optional[str]; de_acc_desc: Optional[str]
    proj_no: Optional[str]; ref_no1: Optional[str]; ref_no2: Optional[str]
    description: Optional[str]; home_dr: Decimal; home_cr: Decimal
